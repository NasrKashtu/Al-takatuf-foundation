      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div 
              key={index}
              className="group hover-scale bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 border border-gray-200 dark:border-gray-700"
            >
              ...
              <div className="p-6">
                ...
                <p className={`text-gray-600 dark:text-gray-300 mb-6 leading-relaxed ${language === 'ar' ? 'text-right' : 'text-left'}`}>
                  {service.description}
                </p>
