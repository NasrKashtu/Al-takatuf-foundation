...
const translations = {
  en: {
    ...
    // Admin — login
    adminTitle: "Admin",
    adminLoginDesc: "Sign in with your authorized Google account to continue.",
    adminGoogleSignIn: "Sign in with Google",
    adminGoogleOnlyHint: "Only Google accounts on the admin allowlist can sign in.",
    adminSignIn: "Sign in",
    adminSignOutAndRetry: "Sign out and try another account",
    adminBackToSite: "Back to site",
    adminLoginEyebrow: "Foundation Admin",
    adminWelcomeTitle: "Welcome back",
    adminWelcomeDesc: "Sign in to manage activities, monitor impact, and keep your community informed.",
    adminNotAllowlistedTitle: "Account not authorized",
    adminNotAllowlistedDesc: "This Google account is not on the admin allowlist:",
    // Admin — chrome
    adminBrand: "Altakathuf · Admin",
    ...
    adminSettingsDesc: "Manage who can sign in to this admin panel.",
    adminAddAdmin: "Add a new admin",
    adminAddAdminDesc: "Type the Google email address. They'll be able to sign in immediately.",
    adminAddAdminEmail: "name@example.com",
    adminAddAdminBtn: "Add",
    adminCurrentAdmins: "Current admins",
    adminNoAdminsYet: "No admins yet — that shouldn't happen!",
    adminRemoveAdmin: "Remove",
    adminCannotRemoveSelf: "You can't remove yourself",
    adminYouLabel: "you",
    adminAddedOn: "Added",
    adminAddedBy: "by",
    adminRemoveConfirmTitle: "Remove admin access?",
    adminRemoveConfirmDesc: "They will no longer be able to sign in:",
    // Admin — dashboard
    adminDashboardDesc: "Overview of the content currently rendered on the public site.",
    adminCategoriesInUse: "Categories in use",
    adminMostRecent: "Most recent",
    adminByCategory: "By category",
    adminRecentActivities: "Recent activities",
    adminNoActivitiesYet: "No activities yet.",
    adminPreviewControls: "Preview controls",
    adminPreviewControlsDesc: "Switch the live site's language and theme without leaving admin.",
    adminLight: "Light",
    adminDark: "Dark",
    // Admin — activities tab
    adminActivitiesDesc: "Create, edit, and delete the posts that appear in the \"Activities & Impact\" section.",
    // Admin — activities panel
    adminSearchPlaceholder: "Search title or description…",
    adminCategory: "Category",
    adminAllCategories: "All categories",
    adminNewestFirst: "Newest first",
    adminOldestFirst: "Oldest first",
    adminTitleAsc: "Title A–Z",
    adminTitleDesc: "Title Z–A",
    adminReset: "Reset",
    adminResetTooltip: "Restore the original six seed activities",
    adminNewActivity: "New activity",
    adminNoActivitiesMatch: "No activities match",
    adminNoActivitiesMatchDesc: "Try clearing filters, or add a new activity.",
    adminEdit: "Edit",
    adminEditAria: "Edit activity",
    adminDelete: "Delete",
    adminDeleteAria: "Delete activity",
    adminDeleteConfirmTitle: "Delete activity?",
    adminDeleteConfirmSuffix: "will be removed from the site. This cannot be undone.",
    adminCancel: "Cancel",
    adminResetConfirmTitle: "Reset to seed data?",
    adminResetConfirmDesc: "Every activity will be replaced with the original six. Any additions or edits you've made will be lost.",
    // Admin — activity form
    adminFormEditTitle: "Edit activity",
    adminFormNewTitle: "New activity",
    adminFormDesc: "All fields display on the public site. Both languages are required.",
    adminFormTitleEn: "Title (English)",
    adminFormTitleAr: "Title (العربية)",
    adminFormDescEn: "Description (English)",
    adminFormDescAr: "Description (العربية)",
    adminFormDate: "Date",
    adminFormCategory: "Category",
    adminFormMediaType: "Media type",
    adminFormImage: "Image",
    adminFormVideo: "Video",
    adminFormImageUrl: "Image URL",
    adminFormImageUrlHint: "Path under /public or an absolute URL.",
    adminFormImageAlt: "Image alt text",
    adminFormImageAltHint: "Shown to screen readers; describe the image.",
    adminFormLocationEn: "Location (English)",
    adminFormLocationAr: "Location (العربية)",
    adminFormLink: "Read-more link",
    adminFormLinkHint: "External URL opened in a new tab.",
    adminSaveChanges: "Save changes",
    adminCreateActivity: "Create activity",
    // Admin — toasts
    adminToastUpdated: "Activity updated.",
    adminToastCreated: "Activity created.",
    adminToastDeleted: "Activity deleted.",
    adminToastReset: "Activities reset to seed data.",
    adminToastTitleRequired: "Both English and Arabic titles are required.",
    adminToastDescRequired: "Both English and Arabic descriptions are required.",
    adminToastLoadFailed: "Failed to load admins.",
    adminToastInvalidEmail: "Please enter a valid email address.",
    adminToastAdminExists: "That email is already an admin.",
    adminToastAddFailed: "Could not add admin.",
    adminToastAdminAdded: "Admin added.",
    adminToastRemoveFailed: "Could not remove admin.",
    adminToastAdminRemoved: "Admin removed.",
    // Not Found
    notFoundCode: "404",
    notFoundTitle: "We couldn't find that page",
    notFoundDesc: "The link may be broken, or the page may have been moved.",
  ...
  ar: {
    ...
    adminLoginDesc: "سجّل الدخول بحساب جوجل المصرّح به للمتابعة.",
    adminGoogleSignIn: "تسجيل الدخول بحساب جوجل",
    adminGoogleOnlyHint: "تستطيع حسابات جوجل المضافة إلى قائمة المشرفين فقط الدخول.",
    adminSignIn: "تسجيل الدخول",
    adminSignOutAndRetry: "تسجيل الخروج وتجربة حساب آخر",
    adminBackToSite: "العودة إلى الموقع",
    adminLoginEyebrow: "إدارة المؤسسة",
    adminWelcomeTitle: "أهلاً بعودتك",
    adminWelcomeDesc: "سجّل الدخول لإدارة الأنشطة، ومتابعة الأثر، وإبقاء مجتمعك على اطّلاع.",
    adminNotAllowlistedTitle: "الحساب غير مصرّح به",
    adminNotAllowlistedDesc: "هذا الحساب غير مدرج في قائمة المشرفين:",
    // Admin — chrome
    adminBrand: "التكاثف · لوحة الإدارة",
    adminViewSite: "عرض الموقع",
    adminLogout: "تسجيل الخروج",
    adminSectionsLabel: "أقسام الإدارة",
    adminDashboard: "لوحة التحكم",
    adminActivities: "الأنشطة",
    adminSettings: "الإعدادات",
    adminSettingsDesc: "إدارة من يمكنه الدخول إلى لوحة الإدارة.",
    adminAddAdmin: "إضافة مشرف جديد",
    adminAddAdminDesc: "أدخل بريد جوجل الإلكتروني للمشرف الجديد. سيتمكّن من الدخول مباشرة.",
    adminAddAdminEmail: "name@example.com",
    adminAddAdminBtn: "إضافة",
    adminCurrentAdmins: "المشرفون الحاليون",
    adminNoAdminsYet: "لا يوجد مشرفون بعد — هذا غير متوقّع!",
    adminRemoveAdmin: "إزالة",
    adminCannotRemoveSelf: "لا يمكنك إزالة نفسك",
    adminYouLabel: "أنت",
    adminAddedOn: "أُضيف في",
    adminAddedBy: "بواسطة",
    adminRemoveConfirmTitle: "إزالة صلاحية الإدارة؟",
    adminRemoveConfirmDesc: "لن يتمكّن هذا الحساب من تسجيل الدخول بعد الآن:",
    // Admin — dashboard
    adminDashboardDesc: "نظرة عامة على المحتوى المعروض حالياً في الموقع العام.",
    adminCategoriesInUse: "الفئات المستخدمة",
    adminMostRecent: "الأحدث",
    adminByCategory: "حسب الفئة",
    adminRecentActivities: "أحدث الأنشطة",
    adminNoActivitiesYet: "لا توجد أنشطة بعد.",
    adminPreviewControls: "عناصر التحكم بالمعاينة",
    adminPreviewControlsDesc: "بدّل لغة الموقع المباشر ومظهره دون مغادرة لوحة الإدارة.",
    adminLight: "فاتح",
    adminDark: "داكن",
    // Admin — activities tab
    adminActivitiesDesc: "إنشاء وتعديل وحذف المنشورات التي تظهر في قسم \"الأنشطة والتأثير\".",
    // Admin — activities panel
    adminSearchPlaceholder: "ابحث في العنوان أو الوصف…",
    adminCategory: "الفئة",
    adminAllCategories: "كل الفئات",
    adminNewestFirst: "الأحدث أولاً",
    adminOldestFirst: "الأقدم أولاً",
    adminTitleAsc: "العنوان أ–ي",
    adminTitleDesc: "العنوان ي–أ",
    adminReset: "استعادة",
    adminResetTooltip: "استعادة الأنشطة الأصلية الست",
    adminNewActivity: "نشاط جديد",
    adminNoActivitiesMatch: "لا توجد أنشطة مطابقة",
    adminNoActivitiesMatchDesc: "جرّب إزالة عوامل التصفية، أو أضف نشاطاً جديداً.",
    adminEdit: "تعديل",
    adminEditAria: "تعديل النشاط",
    adminDelete: "حذف",
    adminDeleteAria: "حذف النشاط",
    adminDeleteConfirmTitle: "حذف النشاط؟",
    adminDeleteConfirmSuffix: "سيُحذف من الموقع. لا يمكن التراجع عن هذا الإجراء.",
    adminCancel: "إلغاء",
    adminResetConfirmTitle: "استعادة البيانات الأصلية؟",
    adminResetConfirmDesc: "سيتم استبدال كل الأنشطة بالأنشطة الأصلية الست. أي إضافات أو تعديلات قمت بها ستُفقد.",
    // Admin — activity form
    adminFormEditTitle: "تعديل نشاط",
    adminFormNewTitle: "نشاط جديد",
    adminFormDesc: "كل الحقول تُعرض في الموقع العام. اللغتان مطلوبتان.",
    adminFormTitleEn: "العنوان (English)",
    adminFormTitleAr: "العنوان (العربية)",
    adminFormDescEn: "الوصف (English)",
    adminFormDescAr: "الوصف (العربية)",
    adminFormDate: "التاريخ",
    adminFormCategory: "الفئة",
    adminFormMediaType: "نوع الوسائط",
    adminFormImage: "صورة",
    adminFormVideo: "فيديو",
    adminFormImageUrl: "رابط الصورة",
    adminFormImageUrlHint: "مسار داخل /public أو رابط مطلق.",
    adminFormImageAlt: "النص البديل للصورة",
    adminFormImageAltHint: "يُعرض لقارئات الشاشة؛ صف الصورة.",
    adminFormLocationEn: "الموقع (English)",
    adminFormLocationAr: "الموقع (العربية)",
    adminFormLink: "رابط اقرأ المزيد",
    adminFormLinkHint: "رابط خارجي يُفتح في علامة تبويب جديدة.",
    adminSaveChanges: "حفظ التغييرات",
    adminCreateActivity: "إنشاء نشاط",
    // Admin — toasts
    adminToastUpdated: "تم تحديث النشاط.",
    adminToastCreated: "تم إنشاء النشاط.",
    adminToastDeleted: "تم حذف النشاط.",
    adminToastReset: "تمت استعادة الأنشطة إلى البيانات الأصلية.",
    adminToastTitleRequired: "العنوان باللغتين الإنجليزية والعربية مطلوب.",
    adminToastDescRequired: "الوصف باللغتين الإنجليزية والعربية مطلوب.",
    adminToastLoadFailed: "تعذّر تحميل قائمة المشرفين.",
    adminToastInvalidEmail: "يُرجى إدخال بريد إلكتروني صالح.",
    adminToastAdminExists: "هذا البريد مضاف بالفعل.",
    adminToastAddFailed: "تعذّر إضافة المشرف.",
    adminToastAdminAdded: "تمت إضافة المشرف.",
    adminToastRemoveFailed: "تعذّرت إزالة المشرف.",
    adminToastAdminRemoved: "تمت إزالة المشرف.",
    // Not Found
    notFoundCode: "404",
    notFoundTitle: "لم نتمكّن من العثور على هذه الصفحة",
    notFoundDesc: "قد يكون الرابط معطوباً، أو ربما تم نقل الصفحة.",
